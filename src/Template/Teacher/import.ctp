...
<div class="desc-message">Click <?= $this->Html->link('here ', '/files/Instruction.pdf', ['download' => 'Instruction.pdf']);?> to view the instruction for filling the csv file</div>
<div class="desc-message">You can upload a CSV file to register your students</div>

    <?php echo $this->Form->create('addForm', ['type'=>'file', 'name'=> 'addForm', 'onSubmit'=>'return validateForm()']); ?>
