...
class UnitsController extends AppController
{
  ...
  /**
  * beforeFilter method: Authenticates user
  *
  */
  public function beforeFilter(Event $event) {
      if ($this->Auth->user('role') != 'admin') {
          $this->Auth->deny(['add','edit','view','index']);
      }
  }
  ...
  public function beforeRender(Event $event) {
    ...
    public function view($id = null)
    {
        $unit = $this->Units->get($id, [
            'contain' => ['Sections', 'Exercises' => ['CulturalNotes','Units']]
        ]);
    ...
    public function add()
    {
        ...
        $sections = $this->Units->Sections->find('list', ['limit' => 200]);
        $this->set(compact('unit', 'sections'));
    }
