 ...
 * @method \App\Model\Entity\Technique|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\Technique findOrCreate($search, callable $callback = null, $options = [])
 */
class TechniquesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('technique')
            ->maxLength('technique', 1000)
            ->requirePresence('technique', 'create')
            ->notEmpty('technique');
