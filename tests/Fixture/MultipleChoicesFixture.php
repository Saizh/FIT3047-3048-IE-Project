...
/**
 * MultipleChoicesFixture
 *
 */
class MultipleChoicesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'multiple_choices_questions_id_fk' => ['type' => 'index', 'columns' => ['question_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'multiple_choice_id_uindex' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
            'multiple_choices_questions_id_fk' => ['type' => 'foreign', 'columns' => ['question_id'], 'references' => ['questions', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
